-- Adminer 4.8.1 MySQL 5.6.47 dump
...
(1,	'Default',	'',	1,	'2023-03-01 17:14:32',	'2023-03-01 17:14:32');
...
(1,	'Рубль',	'RUB',	'',	'р.',	'0',	1.00000000,	1,	'2023-03-02 07:17:35');
...
(32,	'Тестовый модуль',	'test',	'{\"name\":\"\\u0422\\u0435\\u0441\\u0442\\u043e\\u0432\\u044b\\u0439 \\u043c\\u043e\\u0434\\u0443\\u043b\\u044c\",\"product_name\":\"\",\"limit\":\"5\",\"width\":\"200\",\"height\":\"200\",\"status\":\"1\"}');
...
(50,	'999',	'',	'',	'',	'',	'',	'',	'',	1,	7,	'',	0,	1,	1100000.0000,	0,	0,	'2023-03-02',	0.00000000,	1,	0.00000000,	0.00000000,	0.00000000,	1,	1,	1,	1,	1,	0,	'2023-03-02 08:29:28',	'2023-03-02 08:29:28');
...
(50,	1,	'Тестовый товар ',	'&lt;p&gt;Тестовый товар &lt;br&gt;&lt;/p&gt;',	'',	'Тестовый товар ',	'',	'');
...
(887,	0,	1,	'product_id=50',	'testovyj-tovar');
...
('0403f72868cbe8e37abf231003',	'{\"user_id\":\"1\",\"user_token\":\"KGXvBrlQYgSY5tMpRjzQQ2qr1gxGk8y5\"}',	'2023-03-01 15:15:19'),
('112de5da3301bed9747714cd33',	'false',	'2023-03-02 08:21:45'),
('1e18f9e4fc7096e6e0e06da5a5',	'{\"language\":\"ru-ru\",\"currency\":\"RUB\"}',	'2023-03-02 08:17:15'),
('b28ea553a1cfb5af2fd1a358c5',	'{\"user_id\":\"1\",\"user_token\":\"BX1DgeLSTLhWlnCVfSQ2bVdwUh0fPVCk\",\"language\":\"ru-ru\",\"currency\":\"RUB\"}',	'2023-03-02 09:48:53');
...
(11,	0,	'config',	'config_meta_title',	'Интернет магазин Opencart &quot;Русская сборка&quot;',	0),
...
(17,	0,	'config',	'config_zone_id',	'0',	0),
...
(64,	0,	'config',	'config_telephone',	'495 888-88-88',	0),
(202,	0,	'config',	'config_email',	'test@test.ru',	0),
(66,	0,	'config',	'config_geocode',	'',	0),
(67,	0,	'config',	'config_owner',	'Иванов Иван',	0),
(68,	0,	'config',	'config_address',	'г. Москва, ул. Ленина 10 оф. 32',	0),
(69,	0,	'config',	'config_name',	'Интернет магазин Opencart &quot;Русская сборка&quot;',	0),
...
(203,	0,	'config',	'config_encryption',	'',	0),
...
(1,	1,	'admin',	'70de150e0d715f8908170fd42b32d5638d4ebd6f',	'stnzhgNQn',	'John',	'Doe',	'test@test.ru',	'',	'',	'127.0.0.1',	1,	'2023-03-01 17:14:32');
